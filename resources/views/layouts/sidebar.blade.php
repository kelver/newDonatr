<div class="sidebar" x-show="isLogged" x-cloak>
    <div class="sidebar_header border-b border-gray-200 from-gray-100 to-gray-50 bg-gradient-to-t uk-visible@s">
        ...
        <!-- btn night mode -->
        <a id="night-mode" class="btn-night-mode cursor-pointer" data-tippy-placement="down" title="Alternar
        modo
            escuro."></a>
        <span class="btn-mobile cursor-pointer lg:hidden" id="btnCloseMenu"
            uk-toggle="target: #wrapper ; cls: sidebar-active"
            data-tippy-placement="down" title="Fechar menu lateral."></span>
    </div>
    <div class="border-b border-gray-20 flex justify-between items-center p-3 pl-5 relative uk-hidden@s">
        <div>
            <img class="w-36 block dark:hidden" src="{{ asset('assets/images/logo.png') }}">
            <img src="{{ asset('assets/images/logo-light.png') }}" class="w-36 hidden dark:block">
        </div>
