    ...
    <div class="space-y-5 flex-shrink-0 lg:w-7/12">
        ...
        <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
            ...
            <div class="flex justify-between items-center px-4 py-3">
                ...
                <div>
                    <a href="feed.html#"> <i class="icon-feather-more-horizontal text-2xl hover:bg-gray-200 rounded-full p-2 transition -mr-1 dark:hover:bg-gray-700"></i> </a>
                    <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700" uk-drop="mode: hover;pos: top-right">
                        ...
                        <ul class="space-y-1">
                            <li>
                                <a href="feed.html#" class="flex items-center px-3 py-2 hover:bg-gray-200 hover:text-gray-800 rounded-md dark:hover:bg-gray-800">
                            ...
                            <li>
                                <a href="feed.html#" class="flex items-center px-3 py-2 text-red-500 hover:bg-red-100 hover:text-red-500 rounded-md dark:hover:bg-red-600">
            ...
            <div class="py-3 px-4 space-y-3">
                ...
                <div class="flex space-x-4 lg:font-bold">
                    <a href="feed.html#" class="flex items-center space-x-2">
                    ...
                    <a href="feed.html#" class="flex items-center space-x-2 flex-1 justify-end">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
        ...
        <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden">
            ...
            <div class="divide-gray-300 divide-gray-50 divide-opacity-50 divide-y px-4 dark:divide-gray-800 dark:text-gray-100">
                <div class="flex items-center justify-between py-3">
                    ...
                    <a href="feed.html#" class="border border-gray-200 font-semibold px-4 py-1 rounded-full hover:bg-pink-600 hover:text-white hover:border-pink-600 dark:border-gray-800"> Follow </a>
                </div>
                <div class="flex items-center justify-between py-3">
                    <div class="flex flex-1 items-center space-x-4">
                        <a href="profile.html">
            ...
            <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden">
                ...
                <div class="grid grid-cols-2 gap-2 p-3 uk-link-reset">
                    ...
                    <div class="bg-red-500 max-w-full h-32 rounded-lg relative overflow-hidden uk-transition-toggle">
                        <a href="feed.html#story-modal" uk-toggle>
                        ...
                        <div class="flex flex-1 justify-around items-center absolute bottom-0 w-full p-2 text-white custom-overly1 uk-transition-slide-bottom-medium">
                            <a href="feed.html#"> <i class="uil-heart"></i> 150 </a>
                            <a href="feed.html#"> <i class="uil-heart"></i> 30 </a>
                        </div>
                    </div>
